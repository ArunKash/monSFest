...
extern void *mono_aot_module_monSFest_iOS_info;
...
extern void *mono_aot_module_MvvmCross_Plugins_PhoneCall_info;
extern void *mono_aot_module_MvvmCross_Plugins_PhoneCall_iOS_info;
...
{
	mono_aot_register_module (mono_aot_module_monSFest_iOS_info);
	...
	mono_aot_register_module (mono_aot_module_MvvmCross_Plugins_PhoneCall_info);
	mono_aot_register_module (mono_aot_module_MvvmCross_Plugins_PhoneCall_iOS_info);
...
void xamarin_setup_impl ()
{
	...
	xamarin_executable_name = "monSFest.iOS.exe";
	mono_use_llvm = FALSE;
	xamarin_log_level = 0;
